...
//	}
	...
	public AddReservationPage clickLinkByConfirmationNumber(String confirmationNumber) {
	    ...
	    By confirmationCellXpath = By.xpath("//span[contains(@class,'ag-cell-value') and text()='" + confirmationNumber + "']");

	    int maxPages = Integer.parseInt(
	        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("span[ref='lbTotal']")))
	            .getText().trim()
	    );
